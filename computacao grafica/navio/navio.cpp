...
int main(){
   ...
   CIRCULO c1={-100, 0, 20, 5, al_map_rgb(255,0,0)};
   CIRCULO c2={200, 200, 50, 0, al_map_rgb(0,0,255)};
   RETANGULO r1={650,500,100,83, 0.5, al_map_rgb(255,255,255)};
   RETANGULO r2={500,150,80,80,0, amarelo};

navio = al_load_bitmap("navio.png");
ilha = al_load_bitmap("ilha fundo.png");
   ...
   while (true){
       ...
       if (teclas[0]) { r2.x1-=1; } //A
       if (teclas[1]) { r2.x1+=1; } //D
       if (teclas[2]) { r2.y1+=1; } //S
       if (teclas[3]) { r2.y1-=1; } //W
        ...
        al_draw_bitmap(ilha, 0,-100, 0);

        al_draw_bitmap(navio, 650, 500, 0);
